...
![Maximum values of $\Delta \log \mathcal{L}$ as a function of data-span in transit for the NGTS data of NGTS-2b (upper panel). The synthetic data and the transit models are shown at 3 values of $T_{j}$ (lower panels).\label{fig:Figure_1}](Figure_1.png){ width=50% }
